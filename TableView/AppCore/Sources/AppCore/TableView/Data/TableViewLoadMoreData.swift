...
public enum TableViewDataState {
...
public enum TableViewDataLoadMore {
    case yes
    case no
}

public protocol TableViewLoadMoreData: TableViewData {
...
public extension TableViewLoadMoreData {
